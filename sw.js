...
const CACHE = 'roya-apps-v5';
const FILES = ['./', 'index.html', 'deutsch-fuer-roya.html', 'countdown.html', 'baby.html', 'mama.html', 'icon-flower.png', 'icon-heart.png', 'icon-baby.png', 'icon-mama.png'];
